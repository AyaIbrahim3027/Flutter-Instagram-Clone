...
class _SingleReplayWidgetState extends State<SingleReplayWidget> {
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onLongPress: widget.replay.creatorUid == currentUid
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                            ...
                            child: Icon(
                              widget.replay.likes!.contains(currentUid)
                                  ? Icons.favorite
                                  : Icons.favorite_outline,
                              size: 20,
                              color: widget.replay.likes!.contains(currentUid)
                                  ? Colors.red
                                  : darkGreyColor,
                            ))
                      ],
                    ...
                    sizeVer(4),
                    Text(
                      DateFormat("dd/MM/yyy").format(widget.replay.createAt!.toDate()),
