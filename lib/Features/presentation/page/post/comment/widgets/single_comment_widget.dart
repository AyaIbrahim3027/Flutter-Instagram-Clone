...
class _SingleCommentWidgetState extends State<SingleCommentWidget> {
  TextEditingController replayDescriptionController = TextEditingController();
  String currentUid = "";
  ...
  Widget build(BuildContext context) {
    return InkWell(
      onLongPress: widget.comment.creatorUid == currentUid
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                    Row(
                      ...
                      children: [
                        ...
                        GestureDetector(
                            ...
                            child: Icon(
                              widget.comment.likes!.contains(currentUid)
                                  ? Icons.favorite
                                  : Icons.favorite_outline,
                              size: 20,
                              color: widget.comment.likes!.contains(currentUid)
                                  ? Colors.red
                                  : darkGreyColor,
                            ))
                      ],
                    ...
                    isUserReplaying == true
                        ? Column(
                            crossAxisAlignment: CrossAxisAlignment.end,
                            children: [
                              FormContainerWidget(
                                  hintText: "Post your replay...",
                                  controller: replayDescriptionController),
                              sizeVer(10),
                              GestureDetector(
                                onTap: () {
                                  createReplay();
  ...
  createReplay() {
    BlocProvider.of<ReplayCubit>(context)
      ...
      postId: widget.comment.postId,
      commentId: widget.comment.commentId,
      description: replayDescriptionController.text,
    ))
        .then((value) {
      setState(() {
        replayDescriptionController.clear();
        isUserReplaying = false;
      });
    });
  }
  ...
  openBottomModalSheet(
    ...
    return showModalBottomSheet(
        ...
        builder: (context) {
          return Container(
            height: 150,
            decoration: BoxDecoration(color: backGroundColor.withOpacity(.2)),
