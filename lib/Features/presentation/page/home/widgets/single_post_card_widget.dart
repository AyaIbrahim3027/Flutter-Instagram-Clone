        ...
        children: [
          Row(
            ...
            children: [
              ...
              widget.post.creatorUid == currentUid
                  ? GestureDetector(
                      onTap: () {
                        openBottomModalSheet(context, widget.post);
                      },
                      child: const Icon(
                        Icons.more_vert,
                        color: primaryColor,
                  ...
                  GestureDetector(
                      onTap: () {
                        Navigator.pushNamed(context, PageConst.commentPage,
                            arguments: AppEntity(
                                uid: currentUid, postId: widget.post.postId));
          ...
          GestureDetector(
              onTap: () {
                Navigator.pushNamed(context, PageConst.commentPage,
                    arguments:
                        AppEntity(uid: currentUid, postId: widget.post.postId));
              },
              child: Text(
